...
k1 = int(input("Введите для первого файла k = "))
k2 = int(input("Введите для второго файла k = "))
koef1 = create_mn(k1)
koef2 = create_mn(k2)
...
#честно это я не поняла и мне просто сказали что печатать
#если все что было до я и понимала и пошагово делала и гуглила,то вот сумма мне непонятна,но 5 хочется
